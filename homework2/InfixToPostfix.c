 ...
 *sample data
    A+(B*C-(D/E^F)*G)*H // will print ABC*DEF^/G*-H*+
    (A^B*C)/(D*E-F)+G/H // will print AB^C*DE*F-/GH/+
    A*B/(C+D)*(E-F/G)*H // will print AB*CD+/EFG/-*H*
    (A-B)/(C+D*E-F(G/H)) // will print AB-CDE*+FGH/-/
    A/(B+C)*D+E/F^G+H // will print ABC+/D*EFG^/+H+
